...
I've also reviewed legacy, modern, emerging and future techniques and patterns such as: mediator pattern, message queues, DCOM, RPC, CORBA, Protobuf, Cap'n Proto, REST, SOAP, CRUD, MVVM, MVC, MVP, contenteditable, localstorage, Object.observe(), template element, Custom Elements, Web Components, WebSockets, Comet (long polling/SSE), 3-Way Binding, Shadow DOM, AMD, Common.js, Require.js, CSS3D, WebGL, etc.
