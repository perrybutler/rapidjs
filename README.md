...
Some good debates of client vs. server can be read [here](http://openmymind.net/2012/5/30/Client-Side-vs-Server-Side-Rendering/). For what it's worth, we have implemented all of these methods in past projects, including the optimized versions mentioned in the article, providing insight into how the various incarnation of templating engines work.
